...
function App() {
  ...
  //   const canAccessData = await api.asApp().hasPermission('read:confluence-content');
  // if (canAccessData) {
  //     // Fetch and manipulate data securely
  //     const response = await api.asUser().requestConfluence('/rest/api/content/12345');
